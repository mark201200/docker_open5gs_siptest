...
\fancyhead[R]{Cap.1 - Background e contesto} 
\fancyfoot[L]{Cap.1 - Background e contesto} 
\include{Capitolo1}
\fancyhead[R]{Cap.2 - Requisiti e progettazione} 
\fancyfoot[L]{Cap.2 - Requisiti e progettazione} 
\include{Capitolo2}
\fancyhead[R]{Cap.3 - Architettura del framework} 
\fancyfoot[L]{Cap.3 - Architettura del framework} 
\include{Capitolo3}
\fancyhead[R]{Cap.4 - Implementazione} 
\fancyfoot[L]{Cap.4 - Implementazione} 
\include{Capitolo4}
\fancyhead[R]{Cap.5 - Validazione e risultati} 
\fancyfoot[L]{Cap.5 - Validazione e risultati} 
\include{Capitolo5}
\fancyhead[R]{Cap.6 - Conclusioni e sviluppi futuri} 
\fancyfoot[L]{Cap.6 - Conclusioni e sviluppi futuri} 
\include{Capitolo6}
